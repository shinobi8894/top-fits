...
export default function AdvantageCard({
    ...
    return (
        <div className="relative group cursor-pointer w-full">
            <div className="font-sf-impact flex flex-col items-center bg-background z-20 relative">
            ...
            <div className="absolute z-10 -bottom-[8px] left-1/2 -translate-x-1/2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out pointer-events-none">
